...
def _active_deepseek_config(*, model: str = "grok-4.3-high") -> SimpleNamespace:
...
def test_ai_provider_uses_active_admin_model_config(monkeypatch) -> None:
    ...
    assert captured_client["base_url"] == "https://www.sailcode.store"
    ...
    assert captured_request["extra_body"] == {"wire_api": "responses"}
...
def test_ai_provider_rebuilds_when_active_admin_config_changes(monkeypatch) -> None:
    ...
    assert created_clients == ["https://www.sailcode.store", "https://www.sailcode.store"]
